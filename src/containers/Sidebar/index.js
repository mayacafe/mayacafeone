          ...
          <div className="scroll">
            ...
            >
              <Nav vertical className="list-unstyled">
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "admiprofile" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="admiprofile")
                  })}
                >
                  <NavLink
                    to="/app/admiprofile"
                    onClick={e => this.openSubMenu(e, "admiprofile")}
                  >
                    <i className="iconsmind-Administrator" />{" "}
                    <IntlMessages id="menu.admiprofile" />
                  </NavLink>
                </NavItem>

                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "staff" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="staff")
                  })}
                >
                  <NavLink
                    to="/app/staff"
                    onClick={e => this.openSubMenu(e, "staff")}
                  >
                    <i className="iconsmind-Duplicate-Layer" />{" "}
                    <IntlMessages id="menu.staff" />
                  </NavLink>
                </NavItem>
                ...
                >
                  ...
                  >
                    <i className="iconsmind-Structure" />{" "}
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "branch" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="branch")
                  })}
                >
                  <NavLink
                    to="/app/branch"
                    onClick={e => this.openSubMenu(e, "branch")}
                  >
                    <i className="iconsmind-Wizard" />{" "}
        ...
        <div className="sub-menu">
          <div className="scroll">
            ...
            >
              ...
              >
                <NavItem>
                  <NavLink to="/app/product/AddProduct">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.AddProduct"/>
                  </NavLink>
                </NavItem>
               
                <NavItem>
                  <NavLink to="/app/product/UpdateProduct">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.UpdateProduct"/>
                  </NavLink>
                </NavItem>
                ...
                <NavItem>
                  <NavLink to="/app/product/ProductList">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.ProductList" />
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/app/product/ProdDetails">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.ProdDetails" />
                  </NavLink>
                </NavItem>
              </Nav>
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "branch" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="branch")
                })}
                data-parent="branch"
              >
                <NavItem>
                  <NavLink to="/app/branch/AddBranch">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.AddBranch" />
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/app/branch/DetailsBranch">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.DetailsBranch" />
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/app/branch/BranchList">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.BranchList" />
                  </NavLink>
                </NavItem>
              ...
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "admiprofile" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="admiprofile")
                })}
                data-parent="admiprofile"
              >
                <NavItem>
                  <NavLink to="/app/admiprofile/AdmiProfileAccount">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.AdmiProfileAccount" />
                  </NavLink>
                </NavItem>
              ...
              >
                <NavItem>
                  <NavLink to="/app/staff/BranchStaff">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.BranchStaff" />
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/app/staff/UpdateStafff">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.UpdateStafff" />
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/app/staff/StaffList">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.StaffList" />
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/app/staff/StaffDetails">
                    <i className="simple-icon-check" />{" "}
                    <IntlMessages id="menu.StaffDetails" />
                  </NavLink>
                </NavItem>
