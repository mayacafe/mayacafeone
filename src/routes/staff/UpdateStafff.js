      ...
      <Row className="mb-4">
        <Colxx xxs="12">
          <Card>
            <CardBody>
              <CardTitle>
                <IntlMessages id="Add Staff Update Details" />
              </CardTitle>

              <Formik
                initialValues={{
                  username: "Siyakamlesh",
                  accessType: "RW",
                  PhoneNumber: "8574254875",
                  role: "BranchAdmin",
                  address: "Indore Madhya Pradesh",
                  parmanentAddress: "Devas Madhya Pradesh",
                }}
                  ...
                  <Form noValidate onSubmit={handleSubmit}>
                    ...
                    <FormGroup row>
                      <Col md={6} sm={6} col={12}>
                        ...
                        <Label>Role</Label>
                        <select className="new-control-form" name="role"  value={values.role}
                          onChange={handleChange} >
                      <option>select</option>
                      <option values="1">Advertising and marketing</option>
                      <option values="2">Aerospace</option>
                      <option values="3">Agriculture</option>
                      <option values="4"> Computer and technology</option>
                      <option values="5">Construction</option>
                      <option values="6">Education</option>
                    </select>
                      ...
                      <Col md={6} sm={6} col={12}>
                        ...
                        <select className="new-control-form" name="accessType"
                         ...
                         onChange={handleChange} >
                      <option>select</option>
                      <option values="1">BS</option>
                      <option values="2">RW</option>
                      <option values="3">TSC</option>
                      <option values="4"> WD</option>
                      <option values="5">MP</option>
                    </select>
